...
class __TwigTemplate_ee74a4af2a11f0bea37d58dbc9a15c658c7f03f9df7b2bb3b6675c87679b3e39 extends Twig_Template
{
  ...
  <div class=\"post-list--data\">
      ...
      <a href=\"";
        ...
        echo $this->getAttribute(($context["post"] ?? null), "url", array());
        echo "\"><date>";
        echo $this->env->getExtension('Grav\Common\Twig\TwigExtension')->nicetimeFilter($this->getAttribute(($context["post"] ?? null), "date", array()), true);
        echo "</date></a>
      <p>";
        // line 5
...
", "partials/post-item.html.twig", "/var/www/serial-experiments.com/user/themes/medium/templates/partials/post-item.html.twig");
    }
}
